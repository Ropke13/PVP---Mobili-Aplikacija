...
class LearnCorrect extends StatelessWidget {
  ...
  const LearnCorrect({Key? key, required this.theme, required this.question, required this.answer, required this.explain}) : super(key: key);
...
class TestCorrect extends StatelessWidget {
  ...
  final String explain;
  double count;
  TestCorrect({Key? key, required this.theme, required this.count, required this.question, required this.answer, required this.explain}) : super(key: key);
